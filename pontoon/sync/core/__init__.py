...
def notify_users(project: Project, now: datetime) -> None:
    # Strings added in this sync have date_created == now.
    ...
    # Map each subscribed translator to the affected locales they contribute to.
    ...
    # Locale code -> id, used to match a user's custom homepage locale.
    ...
    # contributes to it, otherwise fall back to the largest count among their
    # affected locales.
