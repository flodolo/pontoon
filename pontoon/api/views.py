...
def upload_schema(
    ...
    *,
    ...
    """OpenAPI schema of an upload endpoint, with the responses they all share."""
...
class UploadView(APIView):
    ...
    def run_import(self, importer, *args):
        ...
        Returns the import result and the badge levels the import took the user to,
    ...
    def badge_updates(self, levels: list[tuple[str, int]]) -> dict:
        """Response field reporting the badge levels the import took the user to."""
        return {
            "badge_updates": [
